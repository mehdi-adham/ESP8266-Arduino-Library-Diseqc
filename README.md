...
Add EEPROM Management class and config sensor pin, diseqc pin, motor driver pins with Diseqc and Positioner class
```
//eeprom
...
now decode diseqc message with diseqc.decode(&results) function
```
void setup() { 
  Serial.begin(9600);
  diseqc.begin(); 
